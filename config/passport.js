...
module.exports = function(passport) {
    ...
    passport.use('local-signup', new LocalStrategy({
        // by default, local strategy uses username and password, we will override with pseudo
    ...
    passport.use('local-login', new LocalStrategy({
        // by default, local strategy uses username and password, we could override with email (see before)
        usernameField : 'pseudo',
        passwordField : 'password',
        passReqToCallback : true // allows us to pass back the entire request to the callback
    },
    function(req, pseudo, password, done) { // callback with email and password from our form
