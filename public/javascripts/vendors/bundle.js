 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */const N=` ${d} `;class b{constructor(t,e,n,s){this.strings=t,this.values=e,this.type=n,this.processor=s}getHTML(){const t=this.strings.length-1;let e="",n=!1;for(let s=0;s<t;s++){const t=this.strings[s],i=t.lastIndexOf("\x3c!--");n=(i>-1||n)&&-1===t.indexOf("--\x3e",i+1);const r=x.exec(t);e+=null===r?t+(n?N:h):t.substr(0,r.index)+r[1]+r[2]+m+r[3]+d}return e+=this.strings[t]}getTemplateElement(){const t=document.createElement("template");return t.innerHTML=this.getHTML(),t}}class w extends b{getHTML(){return`<svg>${super.getHTML()}</svg>`}getTemplateElement(){const t=super.getTemplateElement(),e=t.content,n=e.firstChild;return e.removeChild(n),l(e,n.firstChild),t}}
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */class j{handleAttributeExpressions(t,e,n,s){const i=e[0];if("."===i){return new C(t,e.slice(1),n).parts}return"@"===i?[new O(t,e.slice(1),s.eventContext)]:"?"===i?[new S(t,e.slice(1),n)]:new E(t,e,n).parts}handleTextExpression(t){return new P(t)}}const k=new j;
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */n.d(e,"html",(function(){return W})),n.d(e,"svg",(function(){return R})),n.d(e,"DefaultTemplateProcessor",(function(){return j})),n.d(e,"defaultTemplateProcessor",(function(){return k})),n.d(e,"directive",(function(){return i})),n.d(e,"isDirective",(function(){return r})),n.d(e,"removeNodes",(function(){return a})),n.d(e,"reparentNodes",(function(){return l})),n.d(e,"noChange",(function(){return u})),n.d(e,"nothing",(function(){return c})),n.d(e,"AttributeCommitter",(function(){return E})),n.d(e,"AttributePart",(function(){return A})),n.d(e,"BooleanAttributePart",(function(){return S})),n.d(e,"EventPart",(function(){return O})),n.d(e,"isIterable",(function(){return V})),n.d(e,"isPrimitive",(function(){return T})),n.d(e,"NodePart",(function(){return P})),n.d(e,"PropertyCommitter",(function(){return C})),n.d(e,"PropertyPart",(function(){return M})),n.d(e,"parts",(function(){return B})),n.d(e,"render",(function(){return F})),n.d(e,"templateCaches",(function(){return $})),n.d(e,"templateFactory",(function(){return I})),n.d(e,"TemplateInstance",(function(){return y})),n.d(e,"SVGTemplateResult",(function(){return w})),n.d(e,"TemplateResult",(function(){return b})),n.d(e,"createMarker",(function(){return v})),n.d(e,"isTemplatePartActive",(function(){return g})),n.d(e,"Template",(function(){return f})),
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * http://polymer.github.io/PATENTS.txt
 */
(window.litHtmlVersions||(window.litHtmlVersions=[])).push("1.1.2");const W=(t,...e)=>new b(t,e,"html",k),R=(t,...e)=>new w(t,e,"svg",k)}]);